...
% Calculates the orbit of a function and returns orbit's coordinates
%
...
% sequence. This is the sequence of x values. Take away the last two values
% as it is only the reflection point on the diagonal.
